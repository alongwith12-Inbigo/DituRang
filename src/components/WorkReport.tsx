    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-purple-900/10 backdrop-blur-sm overflow-hidden print:bg-white print:p-0 print:block print:overflow-visible">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-12 bg-[#F9F8FD]/50 print:bg-white print:p-0 print:overflow-visible">
          {/* Print Preview Area */}
          <div className="bg-white shadow-xl mx-auto print:shadow-none print:mx-0" style={{ width: '210mm', minHeight: '297mm', padding: '20mm' }}>
            <div ref={printRef} className="w-full text-black font-sans leading-relaxed print:p-0">
              ...
              <div className="text-center mb-12 mt-4">
                <h1 className="text-3xl font-black tracking-[0.3em] mb-10 border-b-4 border-black inline-block pb-2">디지털 튜터 근무확인서</h1>
                <div className="flex justify-end gap-12 mt-4 pr-4">
                  <span className="text-lg font-bold">강사명: <span className="underline underline-offset-[12px] px-8 text-xl font-black">{tutor.name}</span> (서명/인)</span>
                </div>
              </div>

              <table className="report-table text-[12px] text-center">
                <thead>
                  <tr className="bg-gray-100/50 h-12">
                ...
                <tbody>
                  ...
                  <tr className="h-12 bg-gray-50/50 font-bold">
                    <td colSpan={2}>계</td>
              ...
              <div className="mt-12 flex flex-col items-center gap-12">
                <p className="text-lg font-bold">위와 같이 근무하였음을 확인합니다.</p>
                ...
                <div className="mt-12 text-2xl font-black tracking-widest uppercase">
                   인천비즈니스고등학교
                </div>
              </div>
            </div>
